...
export const KiloanIcon: React.FC<IconProps> = ({
  className = "w-12 h-12 text-custom-purple",
}) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    className={className}
...
export const SatuanIcon: React.FC<IconProps> = ({
  className = "w-12 h-12 text-custom-purple",
}) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
...
export const HouseholdIcon: React.FC<IconProps> = ({
  ...
  >
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      d="M8.25 21v-4.875c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125V21m0 0h4.5V3.545M12.75 21h7.5V10.75M2.25 21h1.5m18 0h-18M2.25 9l4.5-1.636M18.75 3l-1.5.545m0 6.205l3 1m-3-1l-3 1.091M15 6.75l2.25 2.25m-1.5-3l-3-1.091M9 15l-3 1m0 0l-3-1m3 1v-4.5m3 4.5l3-1m-12-3l3-1m-3 1l-3-1"
    />
  </svg>
);

export const B2BIcon: React.FC<IconProps> = ({
  className = "w-12 h-12 text-custom-purple",
}) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
  ...
  >
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      d="M3.75 21h16.5M4.5 3h15M5.25 3v18M9.75 3v18m0-18h4.5m-4.5 18h4.5m-4.5-18v18m4.5-18v18m3.75-18v18m0-18h4.5m-4.5 18h4.5m-4.5-18v18"
    />
  </svg>
);
...
export const ShareIcon: React.FC<IconProps> = ({ className = "h-6 w-6" }) => (
  ...
  >
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      d="M7.217 10.907a2.25 2.25 0 100 2.186m0-2.186l5.57-2.81a2.25 2.25 0 11.104-4.223m-5.674 7.033l5.57-2.81a2.25 2.25 0 10.104 4.223"
    />
  </svg>
);
...
export const TruckIcon: React.FC<IconProps> = ({
  ...
  >
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      d="M8.25 18.75a1.5 1.5 0 01-3 0m3 0a1.5 1.5 0 00-3 0m3 0h6m-9 0H3.375a1.125 1.125 0 01-1.125-1.125V14.25m17.25 4.5a1.5 1.5 0 01-3 0m3 0a1.5 1.5 0 00-3 0m3 0h1.125c.621 0 1.125-.504 1.125-1.125V14.25m-17.25 4.5h10.5a2.25 2.25 0 002.25-2.25V6.75a2.25 2.25 0 00-2.25-2.25H3.375c-.621 0-1.125.504-1.125 1.125v1.5c0 .621.504 1.125 1.125 1.125h1.5"
    />
  </svg>
);
...
export const SparklesIconV2: React.FC<IconProps> = ({
  className = "w-12 h-12 text-custom-purple",
}) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
...
export const JacketIcon: React.FC<IconProps> = ({ className = "h-6 w-6" }) => (
  ...
  >
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      d="M8 21V19M8 19H4.764a2 2 0 01-1.789-2.894l3.5-7A2 2 0 018.263 7h7.474a2 2 0 011.789 2.106l-3.5 7A2 2 0 0111.236 19H8z"
    />
  </svg>
);
...
export const ShoesIcon: React.FC<IconProps> = ({ className = "h-6 w-6" }) => (
  ...
  >
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      d="M4 16v-2a3 3 0 013-3h10a3 3 0 013 3v2"
    />
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      d="M20 16H4a2 2 0 00-2 2v1a2 2 0 002 2h16a2 2 0 002-2v-1a2 2 0 00-2-2z"
    />
  </svg>
);
