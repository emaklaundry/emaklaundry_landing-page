    ...
    return (
        <section id="location" className="py-20 bg-white dark:bg-custom-purple-surface">
            <div className="container mx-auto px-6">
                ...
                <div ref={mapRef} className="aspect-w-16 aspect-h-9 rounded-xl overflow-hidden shadow-2xl dark:shadow-none dark:ring-1 dark:ring-custom-purple-border min-h-[450px]">
                    {isVisible ? (
                        <iframe
